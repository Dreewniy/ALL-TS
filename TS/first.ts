...
//     return new Promise((resolve,reject) =>{
//         let result = users.find(num => num.id === id)
//         if(result){
//             setTimeout(() =>{
//                 resolve(result)
//             },2000)
...
//  let AllUsers:Users[] = [
//     {name:"Sargis", age: 18, isStudent: true},
//     {name:"Max", age: 18, isStudent: false}
//  ]

// function showUser(isStudent:boolean): Users | string{
//     let result = AllUsers.find(num => num.isStudent === true)
//     if(result){
//         return result;
//     }else{
//         return "not found";
...
// createPromise<string>("Hello world")

// async function start(){
//     console.log("We try to found")

//     try{
//         const result = await createPromise("Hello World");
//         console.log(result)
//     }catch{
//         console.log("not found")
//     }
...
function RandomNumber<T>(value: T):Promise<T>{
    return new Promise((resolve,reject) =>{
        setTimeout(() =>{
...
async function start(){
    ...
    try{
       const showNumber =  await RandomNumber(Math.random())
       console.log(showNumber);
    }catch{
        console.log("We can't found")
    }
}
start();